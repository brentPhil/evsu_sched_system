<div class="table-responsive" style="min-height: 70vh">
    <table id="inprog" class="table border-secondary-subtle h-100" style="width:100%">
        ...
        foreach ($requests as $request) { if($request['RequestStatus'] === '0'){
